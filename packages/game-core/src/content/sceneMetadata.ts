...
const LAYOUT_PROP_TEXTURES: Partial<Record<SceneLayoutId, Record<string, string>>> = {
  town_gate: {
    ...
    "lantern-post": `${GENERATED_SCENE_ROOT}/prop-town-lantern-post.png`,
    "notice": `${GENERATED_SCENE_ROOT}/prop-town-notice-board.png`,
    "notice-board": `${GENERATED_SCENE_ROOT}/prop-town-notice-board.png`,
    building: `${GENERATED_SCENE_ROOT}/facility-town-gate.png`,
    stall: `${GENERATED_SCENE_ROOT}/facility-town-gate.png`,
  },
  shop: {
    anvil: `${GENERATED_SCENE_ROOT}/prop-shop-anvil-workbench.png`,
    "coal-forge": `${GENERATED_SCENE_ROOT}/prop-shop-coal-forge.png`,
    counter: `${GENERATED_SCENE_ROOT}/prop-shop-anvil-workbench.png`,
    "rack-left": `${GENERATED_SCENE_ROOT}/prop-shop-weapon-rack.png`,
    "rack-right": `${GENERATED_SCENE_ROOT}/prop-shop-weapon-rack.png`,
    "tool-chest": `${GENERATED_SCENE_ROOT}/prop-shop-anvil-workbench.png`,
    "weapon-display": `${GENERATED_SCENE_ROOT}/prop-shop-weapon-rack.png`,
  ...
  inn: {
    "blanket-chest": `${GENERATED_SCENE_ROOT}/prop-inn-blanket-chest.png`,
    hearth: `${GENERATED_SCENE_ROOT}/prop-inn-hearth.png`,
    "tavern-table": `${GENERATED_SCENE_ROOT}/prop-inn-tavern-table.png`,
  ...
  skill_shop: {
    "crystal-lectern": `${GENERATED_SCENE_ROOT}/prop-skill-crystal-lectern.png`,
    altar: `${GENERATED_SCENE_ROOT}/prop-skill-crystal-lectern.png`,
    "archive-left": `${GENERATED_SCENE_ROOT}/prop-skill-scroll-archive.png`,
    "archive-right": `${GENERATED_SCENE_ROOT}/prop-skill-scroll-archive.png`,
    "rune-brazier": `${GENERATED_SCENE_ROOT}/prop-skill-rune-brazier.png`,
    sigil: `${GENERATED_SCENE_ROOT}/prop-skill-rune-brazier.png`,
    "scroll-archive": `${GENERATED_SCENE_ROOT}/prop-skill-scroll-archive.png`,
    building: `${GENERATED_SCENE_ROOT}/facility-skill-shop.png`,
  },
  plaza: {
    banner: `${GENERATED_SCENE_ROOT}/prop-plaza-banner-stand.png`,
    "banner-stand": `${GENERATED_SCENE_ROOT}/prop-plaza-banner-stand.png`,
    "flower-fountain": `${GENERATED_SCENE_ROOT}/prop-plaza-flower-fountain.png`,
    fountain: `${GENERATED_SCENE_ROOT}/prop-plaza-flower-fountain.png`,
    "market-left": `${GENERATED_SCENE_ROOT}/prop-plaza-produce-stall.png`,
    "market-right": `${GENERATED_SCENE_ROOT}/prop-plaza-produce-stall.png`,
    "produce-stall": `${GENERATED_SCENE_ROOT}/prop-plaza-produce-stall.png`,
  ...
  field: {
    "boulder-cluster": `${GENERATED_SCENE_ROOT}/prop-field-boulder-cluster.png`,
    camp: `${GENERATED_SCENE_ROOT}/prop-field-traveler-camp.png`,
    "stone-bank": `${GENERATED_SCENE_ROOT}/prop-field-boulder-cluster.png`,
    "traveler-camp": `${GENERATED_SCENE_ROOT}/prop-field-traveler-camp.png`,
    "tree-stump": `${GENERATED_SCENE_ROOT}/prop-field-tree-stump.png`,
  ...
  boss_arena: {
    "broken-altar": `${GENERATED_SCENE_ROOT}/prop-boss-broken-altar.png`,
    "obsidian-obelisk": `${GENERATED_SCENE_ROOT}/prop-boss-obsidian-obelisk.png`,
    "ritual-brazier": `${GENERATED_SCENE_ROOT}/prop-boss-ritual-brazier.png`,
